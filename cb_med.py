...
def get_response(user_input):
    responses = {
        "hello": "Hello! How can I assist you with your medical queries today?",
        "how are you": "I'm just a program, but I'm here to help you with medical information!",
        "symptoms": "What symptoms are you experiencing? I might be able to provide some information.",
        "diagnosis": "Are you seeking information on specific medical conditions?",
        "diagnosis": "Are you seeking information on specific medical conditions?",
        "default": "I'm not equipped to answer that. Could you ask something related to medical issues?"
    }
